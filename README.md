...
2. Access the App: Go to http://localhost:8000 in your browser.

3. Stop the Container: Press Ctrl+C or run:

docker-compose down

إليك ملف README.md احترافي ومنسق لمشروعك، يشرح كيفية تشغيل المشروع محلياً وباستخدام Docker و Jenkins، مع استبعاد جزء Kubernetes كما طلبت.

يمكنك نسخ هذا الكود ولصقه مباشرة في ملف باسم README.md في مجلد مشروعك.
Markdown
